...
class Update_Validation(ttk.Frame):
    ...
    def update_file(self, old, new):
        ...
        for i in filedata:
            file_w.write(i)
        file_w.close()
        self.success_labeltext = tk.StringVar()
        self.success_labeltext.set("Validation Updated")
        self.success_label = tk.Label(self, textvariable=self.success_labeltext)
