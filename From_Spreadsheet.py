...
class From_Spreadsheet (ttk.Frame):
    ...
    def __init__(self):
        ...
        self.selection_frm = ttk.LabelFrame(self.scrollFrame.viewPort, text="Items")
    ...
    def run_button(self):
        run_button = tk.Button(self.scrollFrame.viewPort, text="Run", command=lambda: self.validate_data(), bg='#7fd1ae')
